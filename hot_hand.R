...
for (n in 1:(length(x))) {
  y_1[n] = get_expected_heads(x[n],nsims = 5000,p=.5,streak=1)
  y_2[n] = get_expected_heads(x[n],nsims = 5000,p=.5,streak=2)
  y_3[n] = get_expected_heads(x[n],nsims = 5000,p=.5,streak=3)
}
